...
class AnalyticsFrame(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        ctk.CTkLabel(total_card, text="📊 Total Cases", font=("Arial", 13, "bold"), text_color="#1a2a4a").pack(pady=(12, 4))
        ...
        ctk.CTkLabel(ongoing_card, text="⏳ Ongoing Cases", font=("Arial", 13, "bold"), text_color="#1a2a4a").pack(pady=(12, 4))
        ...
        resolved_card = ctk.CTkFrame(stats_frame, fg_color="white", corner_radius=10)
        resolved_card.grid(row=0, column=2, padx=4, pady=4, sticky="nsew")
        ctk.CTkLabel(resolved_card, text="✅ Resolved Cases", font=("Arial", 13, "bold"), text_color="#1a2a4a").pack(pady=(12, 4))
        ...
        referred_card = ctk.CTkFrame(stats_frame, fg_color="white", corner_radius=10)
        referred_card.grid(row=0, column=3, padx=4, pady=4, sticky="nsew")
        ctk.CTkLabel(referred_card, text="🔄 Referred Cases", font=("Arial", 13, "bold"), text_color="#1a2a4a").pack(pady=(12, 4))
        ctk.CTkLabel(referred_card, text=str(referred), font=("Arial", 24, "bold"), text_color="#1a73e8").pack(pady=(0, 15))

        # Charts Section
        charts_frame = ctk.CTkFrame(self, fg_color="#f5f5f5")
        ...
        ctk.CTkLabel(pie_card, text="📈 Type of Abuse Distribution", font=("Arial", 15, "bold"), text_color="#1a2a4a", wraplength=320, justify="center").pack(pady=(12, 8))
        ...
        if self.abuse_counts:
            ...
            ax1.axis('equal')
            ax1.set_title('Abuse Types Breakdown', fontsize=12, fontweight='bold', pad=20)
        ...
        ctk.CTkLabel(bar_card, text="📊 Case Status Summary", font=("Arial", 15, "bold"), text_color="#1a2a4a", wraplength=320, justify="center").pack(pady=(12, 8))
        ...
        if self.status_counts:
            ...
            ax2.set_title('Case Status Distribution', fontsize=12, fontweight='bold', pad=20)
        ...
        line_card = ctk.CTkFrame(charts_frame, fg_color="white", corner_radius=10)
        line_card.grid(row=1, column=0, columnspan=2, padx=8, pady=8, sticky="nsew")

        ctk.CTkLabel(line_card, text="📉 Cases Over Time Trend", font=("Arial", 15, "bold"), text_color="#1a2a4a", wraplength=720, justify="center").pack(pady=(12, 8))
        ...
        if self.monthly_counts:
            ...
            ax3.set_title('Monthly Case Trends (2020-2026)', fontsize=12, fontweight='bold', pad=20)
            ax3.set_ylabel('Number of Cases', fontsize=10)
    ...
    def load_data(self):
        try:
            ...
            cursor.execute("SELECT strftime('%Y', date), strftime('%m', date), COUNT(*) FROM vawc_logs GROUP BY strftime('%Y', date), strftime('%m', date)")
